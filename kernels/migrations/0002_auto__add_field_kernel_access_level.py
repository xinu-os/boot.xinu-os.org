...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Kernel.access_level'
        db.add_column(u'kernels_kernel', 'access_level',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Kernel.access_level'
        db.delete_column(u'kernels_kernel', 'access_level')
