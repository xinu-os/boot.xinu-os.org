...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'accounts_profile', (
            ...
            ('affiliation', self.gf('django.db.models.fields.CharField')(max_length=60)),
            ('instructor', self.gf('django.db.models.fields.CharField')(max_length=60)),
        ))
    ...
    models = {
        u'accounts.profile': {
            ...
            'affiliation': ('django.db.models.fields.CharField', [], {'max_length': '60'}),
